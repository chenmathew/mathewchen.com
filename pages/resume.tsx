        ...
        <div className="font-light">
          ...
          <div className="text-sm">
            ...
            <ul>
              ...
              <li>
                Collaborated with team members through Zoom to diagnose and
                solve issues regarding errors in the migration
              </li>
              <li>
                Documented, logged, and resolved migration issues using
          ...
          <div className="text-sm">
            ...
            <ul className="text-sm">
              <li>
                ...
                of the college’s computer network to perform routine checks on
                the college’s servers and printers
              </li>
              <li>
          ...
          <ul className="text-sm">
            <li>
              Styled components with TailwindCSS to make website responsive
            </li>
          ...
          <ul className="text-sm">
            ...
            <li>
              Programmed unit tests to test the quality of the code and
              refactored program to make the functions more testable
            </li>
          </ul>
          ...
          <ul className="text-sm">
            <li>
              ...
              objective of making communication between languages more simple
              and convenient
            </li>
            <li>
          ...
          <div className="text-sm">
            ...
            <p>
              Tools: Git, Vim, VSCode, GDB, Salesforce, Notion, Google Suite
            </p>
          </div>
        </div>
        <a
